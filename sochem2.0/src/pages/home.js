...
export default home;
return (
  <div className="isolate bg-[#040D21]">
      ...
      <nav className="flex items-center justify-start" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <img className="h-8" src="/images/sochem_logo.svg" alt="" />
          </a>
          <div className="pl-4 ">
        ...
        <div className="flex m-auto lg:px-12 py-32 sm:py-48 lg:py-56 justify-between">
          <div className="text-left justify-start">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Unlocking the secrets of the universe, one electron at a time...
            </p>
            <div className="mt-10 flex items-center justify-start gap-x-6">
              <a className="rounded-md bg-indigo-600 px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                Login
              </a>
            </div>
          </div>
          <img className=" w-[30rem] h-[30rem]" src="/images/3.jpg"></img>
        </div>
